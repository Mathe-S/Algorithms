...
""" 1.5 ქულა = 15% 
    5. დავალება 3-ში მიღებული სიტყვების სირავლის გამოყენებით მოახდინეთ ორგანზომილებიანი ლექსიკონის 
       ფორმირება შემდეგი გათვალისწინებით: თუ სიტყვა იწყება ალფავიტის სიმბოლოთი და მთავრდება ციფრითი  
